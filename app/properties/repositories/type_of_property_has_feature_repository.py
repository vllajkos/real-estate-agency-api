...
class TypeOfPropertyHasFeatureRepository:
    ...
    def get_type_of_property_with_features(self, type_of_property_id: str) -> list:
        ...
        """
        return (
            self.db.query(TypeOfPropertyHasFeature)
            .filter(TypeOfPropertyHasFeature.type_of_property_id == type_of_property_id)
            .all()
        )

    def get_type_of_property_with_features_by_optional_values(
        self, type_of_property_id: str, optional_values: bool
    ) -> list:
        """
        ...
        return (
            ...
            .filter(
                ...
                & (TypeOfFeature.optional_values == optional_values)
            )
            .all()
        )

    def get_type_of_property_and_type_of_feature_by_ids(
        self, type_of_property_id: str, feature_id: str
    ) -> TypeOfPropertyHasFeature | None:
        """
        ...
        return (
            ...
            .filter(
                (TypeOfPropertyHasFeature.type_of_property_id == type_of_property_id)
                & (TypeOfPropertyHasFeature.feature_id == feature_id)
            )
            .first()
        )
    ...
    def delete(self, type_of_property_id: str, feature_id: str) -> bool:
        ...
        """
        try:
            prop_feature = self.get_type_of_property_and_type_of_feature_by_ids(
