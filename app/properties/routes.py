...
from app.properties.controller import (
    PropertyController,
    PropertyHasFeatureController,
    TypeOfFeatureController,
    TypeOfPropertyController,
    TypeOfPropertyHasFeatureController,
)
from app.properties.schemas import (
    PropertyHasFeatureSchemaOut,
    PropertyHasFeatureSchemaWAVOut,
    PropertyHasFeatureSchemaWithADIn,
    PropertyHasFeatureSchemaWithoutAVIn,
    PropertySchemaFilter,
    PropertySchemaIn,
    PropertySchemaOut,
    TypeOfFeatureSchemaIn,
    TypeOfFeatureSchemaOut,
    TypeOfPropertyHasFeatureSchemaIn,
    TypeOfPropertyHasFeatureSchemaOut,
    TypeOfPropertySchema,
    TypeOfPropertySchemaIn,
)
...
@type_of_property_router.post(
    "/create", response_model=TypeOfPropertySchema, dependencies=[Depends(JWTBearer("superuser"))]
)
...
@type_of_feature_router.post(
    "/create", response_model=TypeOfFeatureSchemaOut, dependencies=[Depends(JWTBearer("superuser"))]
)
def create_type_of_feature(type_of_feature: TypeOfFeatureSchemaIn):
    """Create type of feature"""
    return TypeOfFeatureController.create(
        feature=type_of_feature.feature, optional_values=type_of_feature.optional_values
    )
...
@type_of_feature_router.get(
    "/get-features-for-type-of-property/{type_of_property_id}", response_model=list[TypeOfFeatureSchemaOut]
)
...
@type_of_feature_router.delete("/delete-by-id", response_model=None, dependencies=[Depends(JWTBearer("superuser"))])
...
type_of_property_has_type_of_feature_router = APIRouter(
    prefix="/api/type-of-property-has-type-of-feature", tags=["Type of property has type of feature"]
)


@type_of_property_has_type_of_feature_router.post(
    "/create", response_model=TypeOfPropertyHasFeatureSchemaIn, dependencies=[Depends(JWTBearer("superuser"))]
)
def create_type_of_property_has_type_of_feature(property_feature: TypeOfPropertyHasFeatureSchemaIn):
    ...
    return TypeOfPropertyHasFeatureController.create(
        type_of_property_id=property_feature.type_of_property_id, feature_id=property_feature.feature_id
    )


@type_of_property_has_type_of_feature_router.get(
    "/get-type-of-property-with-all-features/{type_of_property_id}",
...
@type_of_property_has_type_of_feature_router.get(
    "/get-type-of-property-with-all-features-with-optional-values" "/{type_of_property_id}",
    response_model=list[TypeOfPropertyHasFeatureSchemaOut],
)
...
@type_of_property_has_type_of_feature_router.get(
    "/get-type-of-property-with-all-features-without-optional-values" "/{type_of_property_id}",
    response_model=list[TypeOfPropertyHasFeatureSchemaOut],
)
...
@type_of_property_has_type_of_feature_router.delete(
    "/delete", response_model=None, dependencies=[Depends(JWTBearer("superuser"))]
)
...
def get_properties_by_filter_parameters(filter_para: PropertySchemaFilter):
    ...
    return PropertyController.get_properties_by_filter_parameters(
        municipality=filter_para.municipality,
        city=filter_para.city,
        country=filter_para.country,
...
@property_has_feature_router.post(
    "/create-property-has-feature-with-additional-value",
...
def create_property_has_feature_with_additional_value(property_feature: PropertyHasFeatureSchemaWithADIn):
    ...
    return PropertyHasFeatureController.create(
        property_id=property_feature.property_id,
...
@property_has_feature_router.post(
    "/create-property-has-feature-without-additional-value",
...
def create_property_has_feature_without_additional_value(property_feature: PropertyHasFeatureSchemaWithoutAVIn):
    ...
    return PropertyHasFeatureController.create(
        property_id=property_feature.property_id, feature_id=property_feature.feature_id, additional_feature_value=None
    )


@property_has_feature_router.get(
    "/get-all-features-for-property-by-id/{property_id}", response_model=list[PropertyHasFeatureSchemaOut]
)
...
@property_has_feature_router.delete(
    "/delete-feature-from-property-by-ids", response_model=None, dependencies=[Depends(JWTBearer("user"))]
)
def delete_feature_from_property_by_ids(property_id: str, feature_id: str):
    """Delete feature from property by their ids"""
    return PropertyHasFeatureController.delete_feature_from_property_by_ids(
