...
class AdvertisementController:
    ...
    def create(type_of_ad: Any, price: float, description: str, property_id: str, client_id: str) -> Advertisement:
        ...
        """
        try:
            return AdvertisementService.create(
    ...
    def get_by_filter_parameters(
        ...
        try:
            return AdvertisementService.get_by_filter_parameters(
                type_of_ad=type_of_ad,
                min_price=min_price,
                max_price=max_price,
    ...
    def update_ad_status(clients_id: str, advertisement_id: str, status: Any) -> Advertisement:
        ...
        """
        try:
            return AdvertisementService.update_status(
                clients_id=clients_id, advertisement_id=advertisement_id, status=status
            )
        except CustomAdvertisementExceptions as exc:
            raise HTTPException(status_code=exc.status_code, detail=exc.message)
        except Exception as exc:
    ...
    @staticmethod
    def get_stats(
        type_of_ad: Any, status: Any, type_of_property_id: str, city: str, start_date: str, end_date: str
    ) -> JSONResponse:
        """
        It returns the stats of the advertisements based on the given parameters
        """
        try:
            content = AdvertisementService.get_stats(
                type_of_ad=type_of_ad,
                status=status,
                type_of_property_id=type_of_property_id,
                city=city,
    ...
    def get_stat_on_avg_price_by_city(
        ...
        """
        try:
            content = AdvertisementService.get_stat_on_avg_price_by_city(
                type_of_ad=type_of_ad,
                status=status,
                type_of_property_id=type_of_property_id,
                start_date=start_date,
